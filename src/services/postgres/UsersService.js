...
class UsersService {
    ...
    async getUserById (userId) {
        ...
        // Bila nilainya 0, itu berarti user dengan id yang diminta tidak ditemukan. Bila ini terjadi, throw new NotFoundError sesuai dengan skenario uji Getting User by Incorrect Id
    ...
    async verifyUserCredential(username, password) {
        ...
        if(!result.rows.length) {
            throw new AuthenticationsError('Kredensial yang ada berikan salah')
        };
